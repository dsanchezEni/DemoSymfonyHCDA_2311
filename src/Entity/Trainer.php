...
class Trainer
{
    ...
    #[Assert\NotBlank()]
    #[Assert\Length(max: 255,maxMessage: 'Le prénom doit contenir au maximum 255 caractères')]
    private ?string $firstname = null;

    #[ORM\Column(length: 255)]
    #[Assert\NotBlank()]
    #[Assert\Length(max: 255,maxMessage: 'Le nom doit contenir au maximum 255 caractères')]
